#install script for RT5370 WiFi Dongel.(Ralink)
...
sudo bash -c 'echo "ssid=EnjoyYourFlight" >> /etc/hostapd/hostapd.conf'
...
sudo bash -c 'echo "wpa_passphrase=Genietvanuwreis" >> /etc/hostapd/hostapd.conf'
